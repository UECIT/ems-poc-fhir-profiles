...
public class CareConnectEncounter extends Encounter {
     ...
     */
	@Child(
		name="identifier", type={Identifier.class}, 
    	order=Child.REPLACE_PARENT, min=0, max=Child.MAX_UNLIMITED, modifier=false, summary=true
    )
    @Description(
    	shortDefinition="External Ids for this encounter", 
    	formalDefinition=
    ...
    @Description(
    	shortDefinition="Details about the admission to a healthcare service", 
    	formalDefinition="Details about the admission to a healthcare service." 
    )
    ...
    @Description(
    	shortDefinition="The list of diagnosis relevant to this encounter", 
    	formalDefinition="The list of diagnosis relevant to this encounter." 
    )
    ...
    @Description(
    	shortDefinition="List of locations where the patient has been", 
     ...
     */
    @Child(
    	name="serviceProvider", type={CareConnectOrganization.class}, 
    	order=Child.REPLACE_PARENT, min=0, max=1, modifier=false, summary=false)
    @Description(
    	shortDefinition="The custodian organization of this Encounter record", 
    	formalDefinition=
     ...
     */
    @Child(name="partOf", type={CareConnectEncounter.class}, order=Child.REPLACE_PARENT, min=0, max=1, modifier=false, summary=false)
    @Description(
    ...
    public static class ClassHistoryComponent extends org.hl7.fhir.dstu3.model.Encounter.ClassHistoryComponent {
		...
		@Child(name="class", type={Coding.class}, order=Child.REPLACE_PARENT, min=0, max=1, modifier=false, summary=false)
        @Description(
        	shortDefinition="inpatient | outpatient | ambulatory | emergency +", 
        	formalDefinition="inpatient | outpatient | ambulatory | emergency +."
        )
    ...
    public static class EncounterParticipantComponent extends Encounter.EncounterParticipantComponent {
         ...
         */
        @Child(
        	name="individual", type={CareConnectPractitioner.class, RelatedPerson.class}, 
        ...
        @Description(
        	...
        	formalDefinition="Persons involved in the encounter other than the patient." 
        )
    ...
    public static class DiagnosisComponent extends Encounter.DiagnosisComponent {
         ...
         */
        @Child(
        	name="condition", type={CareConnectCondition.class, CareConnectProcedure.class}, 
        	order=Child.REPLACE_PARENT, min=0, max=1, modifier=false, summary=false
        )
        @Description(
    ...
    public static class EncounterHospitalizationComponent extends Encounter.EncounterHospitalizationComponent {
	    ...
	    @Child(
	    	name="identifier", type={Identifier.class}, 
        	order=Child.ORDER_UNKNOWN, min=0, max=Child.MAX_UNLIMITED, modifier=false, summary=true
        )
        @Description(
        	shortDefinition="External Id for this admission", 
        	formalDefinition=
        		"This records identifiers associated with this condition that are defined "+ 
    	    	"by business processes and/or used to refer to it when a direct URL reference to the resource " +
    	    	"itself is not appropriate (e.g. in CDA documents, or in written / printed documentation)." 
         ...
         */
        @Child(name="origin", type={CareConnectLocation.class}, order=Child.REPLACE_PARENT, min=0, max=1, modifier=false, summary=false)
        @Description(
    		shortDefinition="The location from which the patient came before admission", 
    		formalDefinition="The location from which the patient came before admission." 
    	)
        ...
        @Child(name="admitSource", type={CodeableConcept.class}, order=Child.REPLACE_PARENT, min=0, max=1, modifier=false, summary=false)
        @Description(
        	shortDefinition="From where patient was admitted (physician referral, transfer)", 
        	formalDefinition="From where patient was admitted (physician referral, transfer)." 
        )
         ...
         */
        @Child(name="destination", type={CareConnectLocation.class}, order=Child.REPLACE_PARENT, min=0, max=1, modifier=false, summary=false)
        @Description(
        	shortDefinition="Location to which the patient is discharged", 
        	formalDefinition="Location to which the patient is discharged." 
        )
        ...
        @Child(name="dischargeDisposition", type={CodeableConcept.class}, order=Child.REPLACE_PARENT, min=0, max=1, modifier=false, summary=false)
        @Description(
        	shortDefinition="Category or kind of location after discharge", 
        	formalDefinition="Category or kind of location after discharge." 
        )
    ...
    public static class EncounterLocationComponent extends Encounter.EncounterLocationComponent {
         ...
         */
        @Child(
        	name="location", type={CareConnectLocation.class}, 
        	order=Child.REPLACE_PARENT, min=0, max=1, modifier=false, summary=false
        )
        @Description(
