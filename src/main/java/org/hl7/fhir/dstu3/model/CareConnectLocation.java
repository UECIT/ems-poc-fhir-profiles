...
public class CareConnectLocation extends Location {
	...
	@Child(name="odsSiteCode", type={CareConnectIdentifier.class}, order=0, min=0, max=1, modifier=false, summary=true)
    ...
    @Description(
    	shortDefinition="Organization label locations in registries, need to keep track of those.", 
    	formalDefinition="ODS Site code to identify the organisation at site level" 
    )
    protected List<CareConnectIdentifier> odsSiteCode;
